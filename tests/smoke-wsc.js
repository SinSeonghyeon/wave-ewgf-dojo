...
(async()=>{
 ...
 try{
  await b.send('Page.addScriptToEvaluateOnNewDocument',{source:`localStorage.setItem('wave-ewgf-dojo-v1',JSON.stringify({v:4,lang:'ko',sound:0,fx:0,visitDay:new Date(Date.now()+9*3600e3).toISOString().slice(0,10)}));`});
